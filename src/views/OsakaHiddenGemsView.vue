  ...
  },
  {
    ...
    spots: [
      ...
      },
      {
        ...
        warning: "⚠️ 骨董市每月 21・22 日才舉辦，這次 10/10～10/19 的旅程剛好遇不到。寺院平日仍可入寺參拜，只是沒有骨董市攤。",
      },
      {
        name: "錢湯體驗（銭湯）",
        area: "各地，推薦京橋／天満周邊",
...
const weekendNotes: WeekendNote[] = [
  ...
  {
    spot: "四天王寺骨董市",
    note: "骨董市只在每月 21・22 日舉辦，10/10～10/19 的旅程期間遇不到，無攤位。寺院本身仍可參拜。",
    warn: true,
  },
...
<template>
  <div class="hidden-gems-page">
    <section class="hero-card">
      ...
      <h1>大阪深度旅遊 非觀光客路線</h1>
      <p class="lede">
        給行程待排日的在地人路線——不限哪一天，週末或平日空檔都能走，大家自己看著辦。21 處景點分六大主題，
    ...
    <section class="alert-card">
      <h2>現場提醒</h2>
      <p>
        四天王寺骨董市固定在每月 21・22 日舉辦，這趟 10/10～10/19 剛好遇不到，寺院本身全天可參拜。
        Nintendo OSAKA 與 Pokemon Center 週末人多，建議平日去或 10 點開門即去。
        安排前記得對照「週六 vs 週日」表格確認店家營業狀況。
      </p>
    </section>
